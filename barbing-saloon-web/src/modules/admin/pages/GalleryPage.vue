  ...
  <AdminLayout>
    <section class="space-y-6">
      ...
      <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        <article v-for="item in gallery" :key="item.id" class="overflow-hidden rounded-3xl border border-theme-border bg-theme-surface">
          <div class="flex aspect-[4/3] items-end bg-[linear-gradient(135deg,rgba(13,13,13,0.82),rgba(201,168,76,0.24))] p-6 text-theme-text">
            <div>
