      ...
      <template v-else>
        ...
        <div class="grid gap-5 md:grid-cols-2 lg:grid-cols-4">
          <div class="group relative overflow-hidden rounded-2xl border border-theme-border bg-theme-surface/80 p-6 backdrop-blur-sm transition-all duration-500 hover:-translate-y-1 hover:border-gold/30 hover:shadow-[0_10px_40px_-10px_rgba(212,175,55,0.15)]">
            ...
            <div class="relative z-10 flex flex-col gap-4">
              ...
              <p class="font-display text-4xl text-theme-text group-hover:text-emerald-400 transition-colors">₦{{ Number(analytics.business_stats?.total_revenue || 0).toLocaleString() }}</p>
            </div>
          </div>
          ...
          <div class="group relative overflow-hidden rounded-2xl border border-theme-border bg-theme-surface/80 p-6 backdrop-blur-sm transition-all duration-500 hover:-translate-y-1 hover:border-gold/30 hover:shadow-[0_10px_40px_-10px_rgba(212,175,55,0.15)]">
            ...
            <div class="relative z-10 flex flex-col gap-4">
              <div class="flex items-center gap-3">
                ...
                <p class="text-xs font-semibold uppercase tracking-widest text-ivory/50">Total Appointments</p>
              </div>
              <p class="font-display text-4xl text-theme-text group-hover:text-blue-400 transition-colors">{{ analytics.business_stats?.total_appointments || 0 }}</p>
            </div>
          </div>
          ...
          <div class="group relative overflow-hidden rounded-2xl border border-theme-border bg-theme-surface/80 p-6 backdrop-blur-sm transition-all duration-500 hover:-translate-y-1 hover:border-gold/30 hover:shadow-[0_10px_40px_-10px_rgba(212,175,55,0.15)]">
            ...
            <div class="relative z-10 flex flex-col gap-4">
              <div class="flex items-center gap-3">
                ...
                <p class="text-xs font-semibold uppercase tracking-widest text-ivory/50">New Customers</p>
              </div>
              <p class="font-display text-4xl text-theme-text group-hover:text-indigo-400 transition-colors">{{ analytics.business_stats?.new_customers || 0 }}</p>
            </div>
          </div>
          ...
          <div class="group relative overflow-hidden rounded-2xl border border-theme-border bg-theme-surface/80 p-6 backdrop-blur-sm transition-all duration-500 hover:-translate-y-1 hover:border-gold/30 hover:shadow-[0_10px_40px_-10px_rgba(212,175,55,0.15)]">
            ...
            <div class="relative z-10 flex flex-col gap-4">
              <div class="flex items-center gap-3">
                ...
                <p class="text-xs font-semibold uppercase tracking-widest text-ivory/50">Total Customers</p>
              </div>
              <p class="font-display text-4xl text-theme-text group-hover:text-amber-400 transition-colors">{{ analytics.business_stats?.total_customers || 0 }}</p>
            </div>
          </div>
        </div>
        ...
        <div class="grid gap-6 lg:grid-cols-2">
          ...
          <article class="rounded-2xl border border-theme-border bg-theme-surface/80 p-6 backdrop-blur-sm">
            ...
            <div class="space-y-4">
              <div v-for="day in normalizedBookingTrends" :key="day.month" class="group">
                <div class="flex justify-between text-sm mb-1">
                  <span class="text-ivory/80 font-medium">{{ day.month }}</span>
                  <span class="text-admin font-bold">{{ day.count }} appts</span>
                </div>
              ...
              <div v-if="normalizedBookingTrends.length === 0" class="p-8 text-center text-ivory/40 text-sm">
...
// Computed logic for Booking Trends Progress Bars
const normalizedBookingTrends = computed(() => {
  const days = analytics.value.booking_trends || [];
