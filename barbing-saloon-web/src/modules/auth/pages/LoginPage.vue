      ...
      <div class="w-full max-w-sm">
        <div class="mb-8">
          ...
          <div class="bg-charcoal border border-theme-border/50 rounded-lg p-3 text-xs mb-4">
            ...
            <p class="text-ivory"><span class="text-theme-muted">Email:</span> customer@candycutz.com</p>
            <p class="text-ivory"><span class="text-theme-muted">Password:</span> customer123</p>
          </div>
        </div>
        ...
        <!-- Staff Portals -->
        <div class="mt-8 border-t border-theme-border/50 pt-6 flex flex-col md:flex-row justify-center gap-4 text-xs text-theme-muted">
