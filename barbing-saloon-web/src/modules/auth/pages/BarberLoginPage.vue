    ...
    <div class="hidden lg:flex lg:w-1/2 relative flex-col items-center justify-between p-16 overflow-hidden text-center">
      ...
      <div class="relative z-10 max-w-lg">
        ...
        <p class="text-lg text-theme-muted font-light leading-relaxed">
          Sign in to access the CandyCutz Barber Portal. Manage your schedule, view upcoming appointments, and track your performance.
        </p>
      </div>
      ...
      <div class="w-full max-w-sm">
        <div class="mb-8">
          <div class="text-center">
            <h1 class="font-display font-bold text-3xl sm:text-4xl text-gold mb-4">Barber Portal</h1>
          </div>
          ...
          <div class="bg-charcoal border border-theme-border/50 rounded-lg p-3 text-xs mb-4">
            ...
            <p class="text-ivory"><span class="text-theme-muted">Email:</span> barber@candycutz.com</p>
            <p class="text-ivory"><span class="text-theme-muted">Password:</span> barber123</p>
          </div>
        </div>
          ...
          <div class="relative group">
            ...
            <div class="relative">
              <input 
                v-model="password" 
                id="password"
                class="w-full bg-charcoal border border-graphite rounded-lg px-4 py-3 pr-12 text-white text-sm font-medium placeholder-neutral focus:border-gold focus:ring-1 focus:ring-gold transition-all duration-300 outline-none" 
        ...
        <div class="mt-10 text-center text-sm text-theme-muted">
          ...
          <RouterLink to="/register" class="font-bold text-gold hover:text-gold-dark transition-colors ml-1">
            Create an account
          </RouterLink>
        </div>
