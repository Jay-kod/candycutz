...
import { Appointment, ChairStatus } from '../../src/types';
...
export default function BarberQueueScreen() {
  const router = useRouter();
  const queryClient = useQueryClient();
  const { barber, isAuthenticated, setChairStatus } = useBarberAuthStore();
              ...
              {item.destination_address && (
                <View style={styles.homeAddressBox}>
                  <Text style={styles.homeAddressText}>
                    🏠 Home Delivery: {item.destination_address.street_address}, {item.destination_address.area_landmark}
                  </Text>
                </View>
              )}
