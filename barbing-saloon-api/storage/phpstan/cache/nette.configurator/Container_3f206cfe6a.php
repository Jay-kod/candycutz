...
// source: phar://C:\xampp\htdocs\1\candycutz\barbing-saloon-api\vendor\phpstan\phpstan\phpstan.phar/conf/config.level1.neon
...
class Container_3f206cfe6a extends _PHPStan_c2fbb2235\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_3f206cfe6a $container)
			{
	...
	public function createServiceContainer(): Container_3f206cfe6a
	{
		return $this;
	}
